...
<template>
    <div>
        ...
        <div class="min-h-screen bg-gradient-to-br from-blue-600 via-indigo-500 to-violet-500">
                                    ...
                                    <template #trigger>
                                        <span class="inline-flex rounded-md">
                                            <button type="button"
                                                ...
                                                <svg class="ms-2 -me-0.5 w-4" xmlns="http://www.w3.org/2000/svg"
                                ...
                                <div v-else>
                                    ...
                                    <Dropdown align="right" width="48">
                                        <template #trigger>
                                            ...
                                            <!-- Se o usuário não gerencia fotos de perfil -->
